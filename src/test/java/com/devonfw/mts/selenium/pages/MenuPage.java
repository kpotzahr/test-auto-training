...
public class MenuPage extends Page {
    ...
    private static By sFilterPanelExpandButton = By.cssSelector(
            "body > public-main > div > div > div > mat-sidenav-container > mat-sidenav-content > public-menu > own-menu-filters > form > mat-expansion-panel");
    private static By sPriceSlider = By
            .cssSelector("#cdk-accordion-child-0 > div > div > div > div:nth-child(1) > mat-slider");
    private static By sSliderXPath = By.xpath("//*[@id=\"cdk-accordion-child-0\"]/div/div/div/div[1]/mat-slider");
    private static By sApplyFilter = By.cssSelector(
            "body > public-main > div > div > div > mat-sidenav-container > mat-sidenav-content > public-menu > own-menu-filters > form > div.filter-actions > button.mat-focus-indicator.apply-filter.mat-button.mat-button-base.mat-accent");
    private static By allPriceTags = By.xpath("//span[@class='price']");
    private static By filterChilds = By.xpath(
            "/html/body/public-main/div/div/div/mat-sidenav-container/mat-sidenav-content/public-menu/own-menu-filters/form/div[2]/button[2]/div[1]/descendant::*");
    ...
    private static void setPriceSlider(int price) {
        ...
        // INFO: When using the W3C Action commands, offsets are from the center of
        // element
